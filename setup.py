...
setup(
    name=MODULE_SLUG,
    version="0.1.0",
    author="Joao-Gabriel05",
    author_email="jgffaraco@gmail.com",
    description="A simple hello world module",
    long_description=long_description,
    long_description_content_type="text/markdown",
    url="https://github.com/Joao-Gabriel05/My Awesome Project",  # URL do repositório do seu projeto (se houver)
    ...
    entry_points={
        'console_scripts': [
            f'projecao3d={MODULE_SLUG}.main:app',
        ],
    },
